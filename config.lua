...
Config.ResellPercentage    = 60 -- Sets the Resell Percentage | Example: $100 Car will resell for $75
...
Config.Zones = {
	ShopEntering = { -- Marker for Accessing Shop
		Pos   = { x = 858.74, y = -3203.64, z = 5.9 },
		Size  = { x = 1.5, y = 1.5, z = 1.0 },
		Type  = 36
	},
	ShopInside = { -- Marker for Viewing Vehicles
		Pos     = { x = 1240.52, y = -2994.38, z = 11.73 },
		Size    = { x = 1.5, y = 1.5, z = 1.0 },
		Heading = 89.42,
		Type    = -30
	},
	ShopOutside = { -- Marker for Purchasing Vehicles
		Pos     = { x = 827.32, y = -3209.02, z = 5.28 },
		Size    = { x = 1.5, y = 1.5, z = 1.0 },
		Heading = 180.10,
		Type    = -1
	},
